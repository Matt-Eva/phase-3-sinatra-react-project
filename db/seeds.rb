...
Creation.create({title: "A Blue Monday", content:"The hollow bag /nDrifted silently /nAmongst crumbling chimneys /nOn a blue monday", length: 1, category: "poetry", user_id:User.all.sample.id})
Creation.create({title: "Restful Hollow", content:"I sit beneath a wide canopy of leaves /nfluttering green and white against the soft, blue sky. /nIn this restful hollow, I find the peaceful part of myself /nand quietly sit with it.", length: 1, category: "poetry", user_id:User.all.sample.id})
